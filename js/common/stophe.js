...
! function(t, e) {
	if ("function" == typeof define && define.amd) define([], e);
		...
		var n = e();
		t.Strophe = n.Strophe, t.$build = n.$build, t.$iq = n.$iq, t.$msg = n.$msg, t.$pres = n.$pres, t.SHA1 = n.SHA1, t.MD5 = n.MD5, t.b64_hmac_sha1 = n.b64_hmac_sha1, t.b64_sha1 = n.b64_sha1, t.str_hmac_sha1 = n.str_hmac_sha1, t.str_sha1 = n.str_sha1
	}
}(this, function() {
	var t, e, n;
	return function(i) {
			...
			function r(t, e) {
				var n, i, s, r, o, a, h, c, u, l, d, _, f = e && e.split("/"),
					p = b.map,
					m = p && p["*"] || {};
				if (t) {
					...
					for (n = t.split("/"), u = n.length; u > 0; u -= 1) {
						if (i = n.slice(0, u).join("/"), f)
							for (l = f.length; l > 0; l -= 1)
								if (s = p[f.slice(0, l).join("/")], s && (s = s[i])) {
									r = s, a = u;
									break
								}
						if (r) break;
			...
			p = function(t, e) {
				...
				if (r = r || t, b = l(r), "undefined" === x || "function" === x) {
					for (e = !e.length && n.length ? ["require", "exports", "module"] : e, f = 0; f < e.length; f += 1)
						if (_ = p(e[f], b), u = _.f, "require" === u) T[f] = m.require(t);
						else if ("exports" === u) T[f] = m.exports(t), v = !0;
					else if ("module" === u) a = T[f] = m.module(t);
					else if (s(g, u) || s(S, u) || s(y, u)) T[f] = c(u);
					else {
				...
				e.splice || (n = e, e = []), s(g, t) || s(S, t) || (S[t] = [t, e, n])
			}, n.amd = {
				jQuery: !0
			}
		}(), n("node_modules/almond/almond.js", function() {}),
		function(t, e) {
			return "function" == typeof n && n.amd ? void n("strophe-polyfill", [], function() {
				return e(t)
			}) : e(t)
		}(this, function(t) {
			Function.prototype.bind || (Function.prototype.bind = function(t) {
				...
				for (n = n < 0 ? Math.ceil(n) : Math.floor(n), n < 0 && (n += e); n < e; n++)
		...
		function(t, e) {
			...
			function t(t, i) {
				...
				var o, a, h, c, u, l, d, _, f = new Array(80),
					p = 1732584193,
					m = -271733879,
					g = -1732584194,
					S = 271733878,
			...
			function h(t) {
				for (var e, n, i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", s = "", r = 0; r < 4 * t.length; r += 3)
					for (e = (t[r >> 2] >> 8 * (3 - r % 4) & 255) << 16 | (t[r + 1 >> 2] >> 8 * (3 - (r + 1) % 4) & 255) << 8 | t[r + 2 >> 2] >> 8 * (3 - (r + 2) % 4) & 255, n = 0; n < 4; n++) s += 8 * r + 6 * n > 32 * t.length ? "=" : i.charAt(e >> 6 * (3 - n) & 63);
				return s
			}
			return {
		...
		function(t, e) {
			...
			var t = function(t, e) {
				...
				r = function(n, i, s, r, o, a) {
					return t(e(t(t(i, n), t(r, a)), o), s)
				},
				o = function(t, e, n, i, s, o, a) {
					return r(e & n | ~e & i, t, e, s, o, a)
				},
				a = function(t, e, n, i, s, o, a) {
					return r(e & i | n & ~i, t, e, s, o, a)
				},
				h = function(t, e, n, i, s, o, a) {
					return r(e ^ n ^ i, t, e, s, o, a)
				},
				c = function(t, e, n, i, s, o, a) {
		...
		function(t, e) {
			...
			var t = {
				...
				addCookies: function(t) {
					var e, n, i, s, r, o, a;
					for (e in t || {}) r = "", o = "", a = "", n = t[e], i = "object" == typeof n, s = escape(unescape(i ? n.value : n)), i && (r = n.expires ? ";expires=" + n.expires : "", o = n.domain ? ";domain=" + n.domain : "", a = n.path ? ";path=" + n.path : ""), document.cookie = e + "=" + s + r + o + a
				}
			};
			return t
		}),
		function(t, e) {
			if ("function" == typeof n && n.amd) n("strophe-core", ["strophe-sha1", "strophe-md5", "strophe-utils"], function() {
				...
				var i = e(t.SHA1, t.MD5, t.stropheUtils);
				t.Strophe = i.Strophe, t.$build = i.$build, t.$iq = i.$iq, t.$msg = i.$msg, t.$pres = i.$pres, t.SHA1 = i.SHA1, t.MD5 = i.MD5, t.b64_hmac_sha1 = i.SHA1.b64_hmac_sha1, t.b64_sha1 = i.SHA1.b64_sha1, t.str_hmac_sha1 = i.SHA1.str_hmac_sha1, t.str_sha1 = i.SHA1.str_sha1
			}
		}(this, function(t, e, n) {
			function i(t, e) {
			...
			return a = {
				...
				XHTML: {
					...
					validAttribute: function(t, e) {
						if ("undefined" != typeof a.XHTML.attributes[t] && a.XHTML.attributes[t].length > 0)
							for (var n = 0; n < a.XHTML.attributes[t].length; n++)
				...
				_makeGenerator: function() {
					var t;
					return void 0 === document.implementation.createDocument || document.implementation.createDocument && document.documentMode && document.documentMode < 10 ? (t = this._getIEXmlDom(), t.appendChild(t.createElement("strophe"))) : t = document.implementation.createDocument("jabber:client", "strophe", null), t
				},
				...
				xmlElement: function(t) {
					if (!t) return null;
					var e, n, i, s = a.xmlGenerator().createElement(t);
					for (e = 1; e < arguments.length; e++) {
						var r = arguments[e];
						if (r)
							if ("string" == typeof r || "number" == typeof r) s.appendChild(a.xmlTextNode(r));
							else if ("object" == typeof r && "function" == typeof r.sort)
							for (n = 0; n < r.length; n++) {
								var o = r[n];
								"object" == typeof o && "function" == typeof o.sort && void 0 !== o[1] && null !== o[1] && s.setAttribute(o[0], o[1])
							} else if ("object" == typeof r)
								for (i in r) r.hasOwnProperty(i) && void 0 !== r[i] && null !== r[i] && s.setAttribute(i, r[i])
					}
					return s
				},
					...
					if (t.nodeType === a.ElementType.NORMAL)
						if (s = t.nodeName.toLowerCase(), a.XHTML.validTag(s)) try {
							for (n = a.xmlElement(s), e = 0; e < a.XHTML.attributes[s].length; e++)
								if (r = a.XHTML.attributes[s][e], o = t.getAttribute(r), "undefined" != typeof o && null !== o && "" !== o && o !== !1 && 0 !== o)
									if ("style" === r && "object" == typeof o && "undefined" != typeof o.cssText && (o = o.cssText), "style" === r) {
							...
							for (n = a.xmlGenerator().createDocumentFragment(), e = 0; e < t.childNodes.length; e++) n.appendChild(a.createHtml(t.childNodes[e]));
						else if (t.nodeType === a.ElementType.FRAGMENT)
						for (n = a.xmlGenerator().createDocumentFragment(), e = 0; e < t.childNodes.length; e++) n.appendChild(a.createHtml(t.childNodes[e]));
					else t.nodeType === a.ElementType.TEXT && (n = a.xmlTextNode(t.nodeValue));
					return n
				},
				...
				for (var s in a._connectionPlugins)
				...
				connect: function(t, e, n, i, s, r, o) {
				...
				addHandler: function(t, e, n, i, s, r, o) {
				...
				_changeConnectStatus: function(t, e) {
				...
				_connect_cb: function(t, e, n) {
					...
					if (i) {
						...
						if (s !== a.Status.CONNFAIL) {
							...
							if (u.length > 0)
								for (o = 0; o < u.length; o++) h = a.getText(u[o]), this.mechanisms[h] && c.push(this.mechanisms[h]);
				...
				_attemptLegacyAuth: function() {
					null === a.getNodeFromJid(this.jid) ? (this._changeConnectStatus(a.Status.CONNFAIL, "x-strophe-bad-non-anon-jid"), this.disconnect("x-strophe-bad-non-anon-jid")) : (this._changeConnectStatus(a.Status.AUTHENTICATING, null), this._addSysHandler(this._auth1_cb.bind(this), null, null, null, "_auth_1"), this.send(r({
						type: "get",
						to: this.domain,
						id: "_auth_1"
					}).c("query", {
				...
				_auth1_cb: function(t) {
					...
					return a.getResourceFromJid(this.jid) || (this.jid = a.getBareJidFromJid(this.jid) + "/strophe"), e.up().c("resource", {}).t(a.getResourceFromJid(this.jid)), this._addSysHandler(this._auth2_cb.bind(this), null, null, null, "_auth_2"), this.send(e.tree()), !1
				},
				_sasl_success_cb: function(t) {
					if (this._sasl_data["server-signature"]) {
						var e, n = atob(a.getText(t)),
							i = /([a-z]+)=([^,]+)(,|$)/,
							s = n.match(i);
				...
				_sasl_session_cb: function(t) {
					if ("result" === t.getAttribute("type")) this.authenticated = !0, this._changeConnectStatus(a.Status.CONNECTED, null);
					else if ("error" === t.getAttribute("type")) return a.info("Session creation failed."), this._changeConnectStatus(a.Status.AUTHFAIL, null), !1;
					return !1
				},
				...
				_addSysHandler: function(t, e, n, i, s) {
		...
		function(t, e) {
			return "function" == typeof n && n.amd ? void n("strophe-bosh", ["strophe-core"], function(t) {
			...
			return t.Request = function(e, n, i, s) {
				...
				_attach: function(e, n, i, s, r, o, a) {
				...
				_callProtocolErrorHandlers: function(t) {
					var e, n = this._getRequestStatus(t);
				...
				_getRequestStatus: function(e, n) {
					var i;
		...
		function(t, e) {
			return "function" == typeof n && n.amd ? void n("strophe-websocket", ["strophe-core"], function(t) {
				return e(t.Strophe, t.$build)
			}) : e(Strophe, $build)
		}(this, function(t, e) {
			return t.Websocket = function(t) {
				...
				_check_streamerror: function(e, n) {
					var i;
				...
				_onMessage: function(e) {
					var n, i, s = '<close xmlns="urn:ietf:params:xml:ns:xmpp-framing" />';
		...
		}(this), e(["strophe-polyfill"]), e("strophe")
});